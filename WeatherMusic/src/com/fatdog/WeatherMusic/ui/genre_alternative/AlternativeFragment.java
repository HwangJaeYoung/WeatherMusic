...
public class AlternativeFragment extends Fragment implements ViewForAlternativeFragment.Controller {
	private ViewForAlternativeFragment view;
	private int length;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        view = new ViewForAlternativeFragment(getActivity( ), inflater, container, this); // 뷰를 생성해 낸다.
